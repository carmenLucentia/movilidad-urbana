...
const MarkersPanel = ({ markers, onRemove, onClearAll }: Props) => (
  <div className="flex flex-col gap-3">
    ...
    {markers.length === 0 ? (
      ...
      <>
        ...
        <button
          onClick={onClearAll}
          className="text-xs font-medium text-muted-foreground hover:text-destructive transition-colors self-start"
        >
          Borrar todos
        </button>
      </>
